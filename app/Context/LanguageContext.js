...
const translations = {
  en: {
    ...
    about: {
        ...
        welcome: "Welcome to Stylice Salon – where beauty knows no boundaries. Our mission is to bring out the best in you through personalized care, expert techniques, and luxurious experiences. Step into a world designed to inspire and empower you, with services tailored for every individual.",
        services: "From trendsetting haircuts to revitalizing spa treatments, each service at Stylice Salon is crafted with love and precision. We use only the finest products and cutting-edge techniques to deliver an experience that's truly transformative. Let our skilled team elevate your beauty routine to new heights.",
        exploreServices: "Explore Our Services",
        experience: "Experience the Elegance of Style",
        passions: "At Stylice Salon, we know beauty is an art – and we’re passionate about creating a masterpiece for each of our clients. Visit us today and let us transform your look and uplift your spirit."
      },
      contact: {
        title: "Get in Touch", // Translate title
        description: "We'd love to hear from you! Whether you have a question about our products, pricing, or anything else, our team is here to help.", // Translate description
        ...
        en: {
            ...
            "we strive to provide you with an unforgettable experience.": "we strive to provide you with an unforgettable experience.",
            "Salon Services Menu": "Salon Services Menu",
            "we strive to provide you with an unforgettable experience.": "we strive to provide you with an unforgettable experience.",
          },
        footer:{
          "stylicleSalon": "Stylicle Salon",
          "experienceLuxury": "Experience luxury salon services that enhance your natural beauty.",
          ...
          "subscribeToReceive": "Subscribe to receive exclusive offers and style tips from Stylicle.",
  ...
  ar: {
    ...
    about: {
        ...
        welcome: "مرحباً بك في صالون ستايلس – حيث لا تعرف الجمال حدوداً. مهمتنا هي إبراز أفضل ما لديك من خلال الرعاية الشخصية، وتقنيات الخبراء، وتجارب الفخامة. ادخل إلى عالم مصمم لإلهامك وتمكينك، مع خدمات مصممة لكل فرد.",
        services: "من قصات الشعر الرائجة إلى علاجات السبا المنعشة، كل خدمة في صالون ستايلس مُصممة بحب ودقة. نحن نستخدم فقط أفضل المنتجات والتقنيات الحديثة لتقديم تجربة تحوّلية حقًا. دع فريقنا الماهر يرفع روتين جمالك إلى آفاق جديدة.",
        exploreServices: "استكشف خدماتنا", // "Explore Our Services"
        experience: "استمتع بأناقة الأسلوب", // "Experience the Elegance of Style"
        passions: "في صالون ستايلس، نعرف أن الجمال فن - ونحن متحمسون لإنشاء تحفة لكل من عملائنا. قم بزيارتنا اليوم ودعنا نحول مظهرك ونرفع روحك."
      },
      contact: {
        title: "تواصل معنا", // "Get in Touch"
        description: "يسعدنا سماع آرائكم! سواء كانت لديك أسئلة حول منتجاتنا، أو الأسعار، أو أي شيء آخر، فإن فريقنا هنا لمساعدتك.", // "We'd love to hear from you! Whether you have a question about our products, pricing, or anything else, our team is here to help."
